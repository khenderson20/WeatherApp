...
background_image = tk.PhotoImage(file='./img/clouds.png')
...
button = tk.Button(frame, text="Get Weather!", font=('Helvetica', 12), command=lambda: get_weather(entry.get()), fg='#5b8c85')
